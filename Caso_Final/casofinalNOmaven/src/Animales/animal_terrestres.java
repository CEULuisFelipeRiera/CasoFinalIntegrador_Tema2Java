...
public class animal_terrestres extends animal{
    ...
    public animal_terrestres(String especie, String nombre, String alimentacion, String habitat, String comportamiento, String salud, String id, String tipo, int edad, double peso, boolean patas, boolean cola, boolean pelaje) {
